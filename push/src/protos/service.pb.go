...
func (x *CMQPushServiceReq) Reset() {
	*x = CMQPushServiceReq{}
...
func (x *CMQPushServiceReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CMQPushServiceReq) ProtoMessage() {}

func (x *CMQPushServiceReq) ProtoReflect() protoreflect.Message {
	mi := &file_protos_service_proto_msgTypes[0]
...
// Deprecated: Use CMQPushServiceReq.ProtoReflect.Descriptor instead.
func (*CMQPushServiceReq) Descriptor() ([]byte, []int) {
	return file_protos_service_proto_rawDescGZIP(), []int{0}
}

func (x *CMQPushServiceReq) GetRegion() string {
	if x != nil {
		return x.Region
	}
	return ""
...
func (x *CMQPushServiceReq) GetTopic() string {
	if x != nil {
		return x.Topic
	}
	return ""
...
func (x *CMQPushServiceReq) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
type CMQPushServiceResp struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CMQPushServiceResp) Reset() {
	*x = CMQPushServiceResp{}
	if protoimpl.UnsafeEnabled {
...
func (x *CMQPushServiceResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CMQPushServiceResp) ProtoMessage() {}

func (x *CMQPushServiceResp) ProtoReflect() protoreflect.Message {
	mi := &file_protos_service_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CMQPushServiceResp.ProtoReflect.Descriptor instead.
func (*CMQPushServiceResp) Descriptor() ([]byte, []int) {
	return file_protos_service_proto_rawDescGZIP(), []int{1}
}

func (x *CMQPushServiceResp) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *CMQPushServiceResp) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
var file_protos_service_proto_rawDesc = []byte{
	...
	0x5b, 0x0a, 0x11, 0x43, 0x4d, 0x51, 0x50, 0x75, 0x73, 0x68, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	,
}
...
var file_protos_service_proto_goTypes = []interface{}{
	(*CMQPushServiceReq)(nil),  // 0: service.CMQPushServiceReq
	(*CMQPushServiceResp)(nil), // 1: service.CMQPushServiceResp
}
var file_protos_service_proto_depIdxs = []int32{
	0, // 0: service.CMQ.Push:input_type -> service.CMQPushServiceReq
	1, // 1: service.CMQ.Push:output_type -> service.CMQPushServiceResp
...
func file_protos_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_protos_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CMQPushServiceReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_protos_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CMQPushServiceResp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
